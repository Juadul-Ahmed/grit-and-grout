        ...
        {user && (
          <div className="flex justify-center items-center gap-8">
            <Avatar>
              ...
              <Button size="sm" onClick={handleSignOut} className={"bg-[#27272a] dark:bg-[#06b6d4] text-white text-xs md:text-sm font-bold px-5 py-2 rounded-md hover:bg-[#06b6d4] dark:hover:bg-cyan-400 transition-all shadow-md hover:shadow-cyan-500/20"}>SIgn out</Button>
